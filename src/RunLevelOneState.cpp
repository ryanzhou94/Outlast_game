...
RunLevelOneState::RunLevelOneState(GameEngine* pGameEngine, PlayerObject* pPlayerObject, GameTileManager* pGameTileManager, std::vector<EnemyObject*> pEnemyObjects, std::vector<Fire*> pFire, bool isLoad)
	: RunState(pGameEngine, pPlayerObject, pGameTileManager, pEnemyObjects, pFire, isLoad)
{
}

RunLevelOneState::~RunLevelOneState()
{
}

void RunLevelOneState::virtSetupBackgroundBuffer()
{
	...
	//getPGameEngine()->drawBack
}

void RunLevelOneState::virtInitialiseObjects()
{
	...
	{
		this->getPGameEngine()->storeObjectInArray(1, new EnemyTypeTwo(this->getPGameEngine(), pGameTileManager, 150, 90, pPlayerObject));
		this->getPGameEngine()->storeObjectInArray(2, new EnemyTypeSix(this->getPGameEngine(), pGameTileManager, 100, 600, pPlayerObject));
		this->getPGameEngine()->storeObjectInArray(3, new EnemyTypeSix(this->getPGameEngine(), pGameTileManager, 900, 100, pPlayerObject));
		this->getPGameEngine()->storeObjectInArray(6, new EnemyTypeThree(this->getPGameEngine(), pGameTileManager, 400, 100, pPlayerObject));
...
void RunLevelOneState::virtDrawStringsOnTop()
{
